...
# Page background
bg = patches.Rectangle((4, 3), 102, 134, linewidth=2, edgecolor='#333', facecolor='#fff', zorder=0)
ax.add_patch(bg)

# Helper to create inner section boxes with safe margins
...
nav_items = ['Home', 'Search', 'Health Check', 'Log In', 'Create Account']
x = 10
...
# Save with extra padding to prevent stroke clipping
plt.savefig(r'C:\Users\paron\Desktop\Dev\CS_PROJECT\docs\diagrams\wireframe_home.png', dpi=150, bbox_inches='tight', pad_inches=1.2)
